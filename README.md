...
- **15 个 LLM Provider** — OpenAI / Anthropic / MiniMax / DeepSeek / 智谱 / Moonshot / 千问 / SiliconFlow / 豆包 / 百川 / 阶跃星辰 / 商汤 / 零一万物 / OpenRouter（模型网关） / 本地 Ollama，一键切换
...
vulnclaw config provider minimax   (或 openai/anthropic/deepseek/zhipu/moonshot/qwen/siliconflow/openrouter/ollama)
...
| OpenRouter（模型网关） | `provider openrouter` | anthropic/claude-sonnet-5 |
