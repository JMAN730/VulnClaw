...
> **相关**: AI应用容器逃逸测试 → [ai-baseline-security.md](../../ai-mcp-security/references/ai-baseline-security.md)
...
> **AI应用容器逃逸**: 针对AI Agent/LLM部署环境的容器逃逸测试方法论 → [ai-baseline-security.md](../../ai-mcp-security/references/ai-baseline-security.md) §二十
