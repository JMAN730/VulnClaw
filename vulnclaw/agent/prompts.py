...
from vulnclaw.config.domain_models import phase_canonical_id, phase_display_name
...
def build_system_prompt(
    ...
    # Phase descriptions are selected by identity and render the label through
    # the active localization catalog.
    canonical_phase = phase_canonical_id(phase)
    if canonical_phase and canonical_phase in PHASE_DESCRIPTIONS:
        display = phase_display_name(canonical_phase)
        parts.append(f"## 当前阶段：{display}\n\n{PHASE_DESCRIPTIONS[canonical_phase]}")
