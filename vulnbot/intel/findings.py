"""Findings risk scoring & assessment diff for VulnBot.
...
VulnBot finding dicts and ``target_state`` snapshot dicts, so the canonical
...
from vulnbot.intel.compliance import map_findings
