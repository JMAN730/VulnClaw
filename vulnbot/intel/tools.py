...
def _build_handlers() -> dict[str, Callable[[Any, dict[str, Any]], Awaitable[str]]]:
    ...
    from vulnbot.intel.attack import attack_map_tool
    from vulnbot.intel.compliance import compliance_map_tool
    from vulnbot.intel.cve import cve_lookup_tool
    from vulnbot.intel.findings import findings_diff_tool, findings_report_tool
    from vulnbot.intel.osint import osint_recon_tool
    from vulnbot.intel.remediation import remediation_advice_tool
    from vulnbot.intel.topology import topology_build_tool
