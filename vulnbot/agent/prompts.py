"""VulnBot system prompt builder - dynamic assembly of penetration test prompts."""
...
BASE_IDENTITY = """\
You are VulnBot, a professional AI penetration testing assistant operating only in
