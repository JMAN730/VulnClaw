"""Internationalization support for VulnBot."""
...
class I18nLoader:
    ...
    def detect_language() -> str:
        ...
        Priority:
        1. VULNBOT_LANG environment variable
        2. LANG environment variable
        3. Default to 'en'
        """
        # VulnBot is English-only; accept legacy values but normalize to English.
        lang_env = os.environ.get("VULNBOT_LANG", "").lower()
...
def init_i18n(lang: Optional[str] = None, config: Any = None) -> I18nLoader:
    ...
    Args:
        ...
        config: VulnBot config object with session.language setting
    """
    global _translator
    if lang is None:
        # Try config first
